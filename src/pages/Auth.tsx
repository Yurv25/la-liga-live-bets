...
export default function AuthPage() {
  ...
  useEffect(() => {
    document.title = 'Sign in — Praedictio';
  }, []);
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      ...
      >
        <div className="flex items-center gap-3 mb-1">
          ...
          <h1 className="text-2xl font-bold text-card-foreground font-display">Praedictio</h1>
        </div>
        <p className="text-sm text-muted-foreground mb-5">Predict, compete, win the bragging rights.</p>
